...
! function(a) {
    ...
    var c = function(c, d) {
        var e, f, g, h, i, j, k, l = {},
            ...
            B = function() {
                var b = a("<thead>").append(a("<tr>").append(a("<th>").addClass("prev").attr("data-action", "previous").append(a("<a title='Mese precedente' href='javascript:void(0)'><span>").addClass(d.icons.previous))).append(a("<th>").addClass("picker-switch").attr("data-action", "pickerSwitch").attr("colspan", d.calendarWeeks ? "6" : "5")).append(a("<th>").addClass("next").attr("data-action", "next").append(a("<a title='Mese successivo' href='javascript:void(0)'><span>").addClass(d.icons.next)))),
